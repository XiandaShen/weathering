...
tstress=[1234567 1234567 1234567; 1234567 -depth*0.0275 1234567; 1234567 1234567 1234567];
[si,sj]=find(tstress<100000);
for i=1:wtime
    tstrain(i)={[0 0 0; 0 1234567 0;0 0 0]};  
end  
...
save(['C:\Users\xshen60\Desktop\biotite\code5\sensitivity\casebb',num2str(casen),'c1.mat'],'fc1');

save(['C:\Users\xshen60\Desktop\biotite\code5\sensitivity\casebb',num2str(casen),'a1.mat'],'fa1');

save(['C:\Users\xshen60\Desktop\biotite\code5\sensitivity\casebb',num2str(casen),'omega.mat'],'fomega');
save(['C:\Users\xshen60\Desktop\biotite\code5\sensitivity\casebb',num2str(casen),'tstrainv.mat'],'ftstrainv');
save(['C:\Users\xshen60\Desktop\biotite\code5\sensitivity\casebb',num2str(casen),'ctstrainv.mat'],'cftstrainv');
