...
if casen==51
   pro=[0.01 0.01 0.01 0.97]; 
end
if casen==52
   pro=[0.01*5/3 0.01*5/3 0.01*5/3 0.95]; 
end
if casen==53
   pro=[0.01*7/3 0.01*7/3 0.01*7/3 0.93]; 
end
if casen==54
   pro=[0.01*9/3 0.01*9/3 0.01*9/3 0.91]; 
end  
if casen==55
   pro=[0.01*11/3 0.01*11/3 0.01*11/3 0.89]; 
end  
if casen==56
   pro=[0.01*13/3 0.01*13/3 0.01*13/3 0.87]; 
end 
if casen==57
   pro=[0.01*15/3 0.01*15/3 0.01*15/3 0.85]; 
end 
if casen==58
   pro=[0.01*17/3 0.01*17/3 0.01*17/3 0.83]; 
end 
...
if casen==70
    theta=pi/2.*[15/90,15/90,15/90,0]; 
end
if casen==71
    theta=pi/2.*[30/90,30/90,30/90,0]; 
end
...
if casen==74
    theta=pi/2.*[75/90,75/90,75/90,0]; 
end
if casen==75
...
co=[1,1,1,1];
if casen==59
   ao=[1.00001,1.00001,1.00001,1.00001]; 
end
if casen==60
   ao=[2,2,2,1.00001]; 
end
...
tstress=[1234567 1234567 1234567; 1234567 1234567 1234567; 1234567 1234567 -depth*0.0196];
...
matrix_strain{t}=pstrain{phasen};
% no damage
% omega(t+1)=0;
