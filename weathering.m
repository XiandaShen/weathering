...
% for i=1:wtime
%     tstrain(i)={[1234567 0 0; 0 0 0;0 0 0]};  
% end  
...
for i=1:phasen-1
    wr(i)=wr(i)+wrct*inter*((a(i)^(3.2)+2*(a(i)*c(i))^(1.6))^(1/1.6))/a(i)/a(i)/c(i);
...
Dt=cell(phasen,phasen);
 ...
 %    tempt1=zeros(3,3);
 [tstress,tstrain{t}]=bc(tstress,tstrain{t},HC,tempt1);    
 end
...
save('/Users/caihejushi/Documents/academic/PHD/pressure_thermal/code/odc1.mat','c1');
save('/Users/caihejushi/Documents/academic/PHD/pressure_thermal/code/odc2.mat','c2');
save('/Users/caihejushi/Documents/academic/PHD/pressure_thermal/code/odc3.mat','c3');
save('/Users/caihejushi/Documents/academic/PHD/pressure_thermal/code/oda1.mat','a1');
save('/Users/caihejushi/Documents/academic/PHD/pressure_thermal/code/oda2.mat','a2');
save('/Users/caihejushi/Documents/academic/PHD/pressure_thermal/code/oda3.mat','a3');
save('/Users/caihejushi/Documents/academic/PHD/pressure_thermal/code/odomega.mat','omega');
save('/Users/caihejushi/Documents/academic/PHD/pressure_thermal/code/odtstrainv.mat','tstrainv');
